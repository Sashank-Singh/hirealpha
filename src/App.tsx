      ...
      <div className="container">
        <div className="connectors">
          <div className="connectors__copy">
            ...
            <h2>Plug Alpha into the apps you already use.</h2>
            <p>
    ...
    <>
      ...
      <nav className="nav">
        <div className={`nav__pill${scrolled ? ' nav__pill--scrolled' : ''}`}>
          <a href="#" className="nav__brand">
            <span className="nav__mark">α</span>
            HireAlpha
          </a>
      ...
      <main>
        <section className="container hero">
          <div>
            <p className="hero__eyebrow">Three hires in iMessage</p>
            <h1>
              people in your texts you can actually <em>hire</em>
            </h1>
            <p className="hero__sub">
              Friend, Coworker, and Cofounder. Three characters, three numbers, $19/mo each. Not one assistant with modes. Real hires in Messages.
            </p>
        ...
        <section className="section" id="roles">
          <div className="container">
            <div className="roles-head">
              <h2>Not one assistant. Three hires.</h2>
              <p>
                Pick the relationship you need. Each agent is a different person with a different number, not modes of the same chatbot.
              </p>
            </div>
        ...
        <section className="section" id="how">
          <div className="container">
            <div className="how">
              <h2>Save a number. Start texting. That’s it.</h2>
      ...
      <footer className="container footer">
        <p><strong>HireAlpha</strong>. Hire Friend, Coworker, or Cofounder in your texts.</p>
        <p>© {new Date().getFullYear()} HireAlpha</p>
      </footer>
    </>
  )
}
