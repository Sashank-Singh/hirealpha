...
> = {
  friend: {
    tools: ['gmail', 'calendar.read', 'calendar.soft_book', 'drive', 'maps', 'plaid', 'spotify', 'youtube', 'whatsapp', 'telegram', 'twitch', 'vimeo', 'loom', 'zoom', 'meet'],
    executable: ['gmail', 'calendar', 'drive', 'maps', 'plaid', 'spotify', 'youtube', 'whatsapp', 'telegram', 'twitch', 'vimeo', 'loom', 'zoom', 'meet'],
    miniApps: [
      ...
      'networking_crm', 'sleep_tracker', 'spending_snapshot', 'spiral_options', 'relationship_radar',
    ],
