...
const HOME: Record<WorkoutWeekday, WorkoutSession> = {
  1: {
    ...
    moves: [
      ...
      { name: 'Dumbbell floor press', sets: 3, reps: 10, restSec: 75 },
      { name: 'Bench dips', sets: 3, reps: 12, restSec: 60 },
      { name: 'Lateral raise', sets: 3, reps: 12, restSec: 60 },
  ...
  2: {
    ...
    name: 'Pull',
    moves: [
      { name: 'Dumbbell row', sets: 4, reps: 10, restSec: 75 },
      { name: 'Rear delt raise', sets: 3, reps: 12, restSec: 60 },
      { name: 'Superman', sets: 3, reps: 12, restSec: 60 },
      { name: 'Dumbbell curl', sets: 3, reps: 10, restSec: 60 },
      { name: 'Dumbbell pullover', sets: 3, reps: 10, restSec: 60 },
      { name: 'Hammer curl', sets: 3, reps: 10, restSec: 60 },
    ],
  },
  3: {
    ...
    name: 'Legs',
    moves: [
      { name: 'Goblet squat', sets: 4, reps: 10, restSec: 75 },
      { name: 'Dumbbell RDL', sets: 3, reps: 10, restSec: 75 },
      { name: 'Reverse lunge', sets: 3, reps: 10, restSec: 75 },
      { name: 'Glute bridge', sets: 3, reps: 12, restSec: 60 },
      { name: 'Wall sit', sets: 3, reps: 30, restSec: 60 },
      { name: 'Calf raise', sets: 3, reps: 15, restSec: 45 },
    ],
  },
  4: {
    ...
    moves: [
      ...
      { name: 'Dumbbell row', sets: 3, reps: 10, restSec: 75 },
      { name: 'Dumbbell overhead press', sets: 3, reps: 8, restSec: 75 },
      { name: 'Rear delt raise', sets: 3, reps: 12, restSec: 60 },
      { name: 'Hammer curl', sets: 3, reps: 10, restSec: 60 },
      { name: 'Bench dips', sets: 3, reps: 12, restSec: 60 },
    ],
  ...
  5: {
    ...
    moves: [
      ...
      { name: 'Single leg RDL', sets: 3, reps: 8, restSec: 75 },
      { name: 'Hip thrust', sets: 3, reps: 10, restSec: 60 },
      { name: 'Calf raise', sets: 3, reps: 15, restSec: 45 },
      { name: 'Glute bridge', sets: 3, reps: 12, restSec: 60 },
