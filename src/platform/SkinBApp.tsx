...
export function SkinBApp({ auth }: { auth: FeatureAuth }) {
  ...
  return (
    <div className="hb-screen">
      ...
      <Link className="hb-builds-btn" to={miniLink('builds')}>
        <span className="hb-builds-icon" aria-hidden="true">
          <MiniAppIcon kind="builds" />
        </span>
        <span className="hb-builds-copy">
          <strong>Your build</strong>
          <small>Every app Alpha built for you</small>
        </span>
        <span className="hb-builds-go" aria-hidden="true">
