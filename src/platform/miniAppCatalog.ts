...
export const APP_ALIASES: Record<string, string> = {
  ...
  people: 'networking_crm',
  network: 'networking_crm',
  crm: 'networking_crm',
  promises: 'open_loops',
  loops: 'open_loops',
  gratitude: 'home',
...
export const MENU_FEATURES: Record<string, MenuFeature[]> = {
  friend: [
    ...
    { kind: 'later', title: 'Later', emoji: '📥', blurb: 'Drop zone, learning, and promises.', sample: 'save for later' },
...
export const KIND_TITLES: Record<string, { title: string; blurb: string }> = {
  ...
  later: { title: 'Later', blurb: 'Drop zone, learning queue, and promises.' },
