...
/** Quiet line icons. Same weight, no fill blobs, one idea per app. */
const ICONS: Record<string, ReactNode> = {
  ...
  spending_snapshot: (
    <g {...STROKE}>
      <rect x="3.8" y="7.2" width="16.4" height="9.6" rx="1.6" />
      <circle cx="12" cy="12" r="2.1" />
    </g>
  ),
  mirror: (
    <g {...STROKE}>
      <rect x="7" y="4.4" width="10" height="15.2" rx="2.2" />
      <path d="M9.4 8.2v4.4" />
    </g>
  ),
  networking_crm: (
  ...
  digest: (
    <>
      <g {...STROKE}>
        <rect x="4.6" y="6.2" width="14.8" height="13.2" rx="2" />
        <path d="M4.6 10.2h14.8" />
        <path d="M8.2 4.6v3" />
        <path d="M15.8 4.6v3" />
      </g>
      <circle cx="9.2" cy="14.4" r="1.05" fill="currentColor" />
    </>
  ),
  learning_queue: (
    <g {...STROKE}>
  ...
  meeting_mode: (
    <g {...STROKE}>
      <rect x="3.8" y="7" width="12.2" height="10" rx="1.8" />
  ...
  standup_paste: (
    <g {...STROKE}>
      <rect x="6.2" y="5.6" width="11.6" height="13.8" rx="1.6" />
      <rect x="9" y="4.4" width="6" height="2.6" rx="0.8" />
      <path d="M9 11h6" />
      <path d="M9 14.2h4.4" />
    </g>
  ),
  ...
  pipeline_board: (
    <g {...STROKE}>
      <rect x="4.2" y="5.4" width="4.4" height="13.2" rx="1" />
      <rect x="9.8" y="5.4" width="4.4" height="8.8" rx="1" />
      <rect x="15.4" y="5.4" width="4.4" height="11.2" rx="1" />
    </g>
  ),
  relationship_radar: (
    <>
      ...
      <circle cx="16.4" cy="8.4" r="1.2" fill="currentColor" />
    </>
  ),
  kill_keep_park: (
    <g {...STROKE}>
...
export function MiniAppIcon({ kind }: { kind: string }) {
  return <Mark>{ICONS[kind] ?? FALLBACK}</Mark>
}
