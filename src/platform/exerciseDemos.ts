...
export const EXERCISE_DEMO_MAP: Record<string, string> = {
  ...
  'pushups': `/workout/push-ups.gif?v=${DEMO_V}`,
  'push up': `/workout/push-ups.gif?v=${DEMO_V}`,
  'plank shoulder taps': `/workout/plank.gif?v=${DEMO_V}`,
  'shoulder taps': `/workout/plank.gif?v=${DEMO_V}`,
  ...
  'leg extensions': `/workout/leg-extension.gif?v=${DEMO_V}`,
  'hanging knee raise': `/workout/hanging-knee-raise.jpg?v=${DEMO_V}`,
  'hanging knee raises': `/workout/hanging-knee-raise.jpg?v=${DEMO_V}`,
  'incline bench': `/workout/incline-bench.gif?v=${DEMO_V}`,
  'incline bench press': `/workout/incline-bench.gif?v=${DEMO_V}`,
  'pull ups': `/workout/pull-ups.jpg?v=${DEMO_V}`,
  'pullups': `/workout/pull-ups.jpg?v=${DEMO_V}`,
  'pull up': `/workout/pull-ups.jpg?v=${DEMO_V}`,
