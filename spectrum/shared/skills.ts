...
> = {
  friend: {
    ...
    miniApps: ['pick_night', 'check_in', 'spiral_options', 'open_loops', 'relationship_radar', 'drop_zone', 'nutrition'],
  ...
  coworker: {
    ...
    miniApps: ['approve_send', 'pick_slot', 'standup_paste', 'linear_triage', 'open_loops', 'meeting_mode', 'drop_zone'],
  ...
  cofounder: {
    ...
    miniApps: ['kill_keep_park', 'hire_decision', 'weekly_focus', 'approve_investor_note', 'decision_ledger', 'relationship_radar', 'drop_zone', 'open_loops'],
