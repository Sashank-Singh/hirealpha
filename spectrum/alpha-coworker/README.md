...
Alpha (Coworker), the work colleague hire. A [Spectrum](https://photon.codes/docs/spectrum-ts) app wired with `imessage`, running the shared HireAlpha turn engine from `../shared` (same runtime as alpha and alpha-cofounder):
...
- iMessage app cards for the coworker mini apps (Brief, Home, Meeting mode, Approve and send, Pick a slot, Linear triage, Standup, …)
